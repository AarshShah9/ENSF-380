...
public class ExistingFunctionalityTest {
    ...
    // assertEquals("First licence is not stored, or not stored in order",
    // expectedValues[0], actualValues[0]);
    // assertEquals("Second licence is not stored, or not stored in order",
    // expectedValues[1], actualValues[1]);
    ...
    // assertEquals("Second licence is not stored, or not stored in order",
    // expectedValues[1], actualValues[1]);
    // assertEquals("Fourth licence did not overwrite third licence",
    // expectedValues[2], actualValues[2]);
    // }

    // @Test
    // public void testRemoveLicence() {
    // var testObject3 = new HouseholdParking(expectedTaxRoll, givenZoning,
    // expectedStreet, expectedNumber,
    // givenPostCode);
    ...
    // assertFalse("removeResidentLicence() did not return false when the licence
    // couldn't be found", status);
    ...
    // assertEquals("First licence was affected by removing middle licence",
    // expectedValues[0], actualValues[0]);
    // assertEquals("Original third licence is not second after removal of second
    // licence", expectedValues[1],
    // actualValues[1]);
    // assertTrue("Third licence position is not empty after removing middle item",
    // (actualValues[2] == null));
    // assertTrue("removeResidentLicence() did not return true after removing a
    // licence", status);

    // status = testObject3.removeResidentLicence();
    // actualValues = testObject3.getResidentLicence();
    // assertTrue("First licence position is not empty after removing all",
    // (actualValues[0] == null));
    // assertTrue("Second licence position is not empty after removing all",
    // (actualValues[1] == null));
    // assertTrue("removeResidentLicence() did not return true after removing all
    // licences", status);
    // }
